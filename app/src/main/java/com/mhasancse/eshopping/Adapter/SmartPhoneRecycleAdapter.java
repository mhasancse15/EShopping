...
public class SmartPhoneRecycleAdapter extends RecyclerView.Adapter<SmartPhoneRecycleAdapter.MyViewHolder> {
    ...
    public SmartPhoneRecycleAdapter(Context context, ArrayList<FavouriteModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public SmartPhoneRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_smartphone_list, parent, false);


        return new SmartPhoneRecycleAdapter.MyViewHolder(itemView);
